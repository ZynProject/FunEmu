...
enum WorldBoolConfigs
{
    ...
    CONFIG_AUTO_SPELL_LEARN_ENABLE,
    CONFIG_GUILD_LEVELING_ENABLE,
...
enum WorldFloatConfigs
{
    ...
    CONFIG_DONATOR_XPMODIFIER,
    CONFIG_DONATOR_REPMODIFIER,
    CONFIG_GUILD_XPMODIFIER,
    CONFIG_STATS_LIMITS_ARMOR_PENETRATION,
    CONFIG_GUILD_MONEYMODIFIER,
...
enum WorldIntConfigs
{
    ...
    CONFIG_DONATOR_CRAFTMODIFIER,
    CONFIG_DONATOR_CRAFTBONUS,
    CONFIG_GUILD_MAXLEVEL,
    CONFIG_GUILD_MAXCOOLDOWN_PER_ID,
    CONFIG_GUILD_MAXRESPAWN_PER_ID,
