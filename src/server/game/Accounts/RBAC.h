...
RBAC_PERM_FEATURE_CRAFTMODIFIER = 1002,
...
RBAC_PERM_COMMAND_GXP_MOBIL = 1205,
RBAC_PERM_COMMAND_GXP_BUFF = 1206,
RBAC_PERM_COMMAND_GXP_SUMMON = 1207,
RBAC_PERM_COMMAND_GXP_REZZ = 1208,
RBAC_PERM_COMMAND_GXP_COOLDOWN = 1209,
RBAC_PERM_COMMAND_GXP_RESPAWN = 1210,
RBAC_PERM_MAX
};
